...
class MyAppState extends State<MyApp> {
  ...
  loadWeather() async {
    ...
    final lat = 37.207461;
    final lon = 127.088394;

    final weatherResponse = await http.get(
        'https://api.openweathermap.org/data/2.5/weather?appid=e1ae8a7808b51b1e8fc9817b5f928f88&lat=${lat
            .toString()}&lon=${lon.toString()}');
    final forecastResponse = await http.get(
        'https://api.openweathermap.org/data/2.5/forecast?appid=e1ae8a7808b51b1e8fc9817b5f928f88&lat=${lat
            .toString()}&lon=${lon.toString()}');
